...
export async function ChatFriends({ searchParams }){
  ...
  return  <>
        ...
        {friends.length > 0 ? <section className="overflow-scroll">
            ...
            return  <section  >
              ...
              <main className="flex items-center">
                ...
                <section className="mt-0">
                  ...
                  <h4 className="text-xs tracking-wide -ml-1 text-slate-600">Tap here to start message.</h4>
                </section>
              </main>
          ...
          {/* <br /> */}
          {/* <Image src={chatImg} alt="img" className="w-[100px] h-[40%] md:w-[55%] md:h-[55%] ml-12 cursor-pointer select-none" /> */}
        ...
        : 
        <section className="flex items-center flex-col justify-center" style={{marginTop: "50px"}}>
            <br />
            <Image src={chatImg} alt="img" width={`250`} height={`250`} style={{marginBottom:"20px"}} className=" cursor-pointer select-none" />
            <h3 className="font-bold font-[helvetica] tracking-wide text-center" >No Friends Found</h3>
          </section>}
        {/* friends added */}
  </>
}